...
public class ItemRequestMapperTest {
    ...
    private final ItemRequest itemRequest = new ItemRequest(1L, "description", requestor, LocalDate.now());
    ...
    private final ItemRequestDto dto = new ItemRequestDto(1L, "description", requestorDto, LocalDate.now());
